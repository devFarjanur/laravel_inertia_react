...
export default function Navbar({ className }) {
    ...
    useEffect(() => {
        if (categoryToggle) {
            const getItems =
                document.querySelectorAll(`.categories-list li`).length;
            ...
            <div className="container-x mx-auto h-full">
                <div className="w-full h-full relative">
                    <div className="w-full h-full flex justify-between items-center">
                        ...
                        {/* CENTER: Nav Menu */}
                        <div className="nav flex-1 flex justify-center items-center">
                            <ul className="nav-wrapper flex xl:space-x-13 space-x-8">
                                <li className="relative">
                                    <Link to="/">
                                        <span className="flex items-center text-base text-white font-600 cursor-pointer ">
                                            <span>Home</span>
                                        </span>
                                    </Link>
                                </li>
